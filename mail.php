							...
							<div class="mail-grids">
								<div class="mail-top">
									<div class="col-md-4 mail-grid">
										...
										<h5>Address</h5>
										<p>9th floor - Palace Building - 221B Walk of Fame - Jamnagar</p>
									</div>
									<div class="col-md-4 mail-grid">
										<i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>
										<h5>Phone</h5>
										<p>Telephone:  +91 800 603 6035</p>
									</div>
									<div class="col-md-4 mail-grid">
										<i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>
										<h5>E-mail</h5>
										<p>E-mail:<a href="mailto:example@mail.com"> fashionstreet@gmail.com</a></p>
									</div>
