...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/uikit_modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
	<meta charset="UTF-8">
		...
		<ul class="menu-items custom-scroll">
			...
			<li>
				...
				<ul class="sub-menu">
					...
					<li>
						<a href="uikit_modals.html" class="active">
					...
					<div class="col-12">
						<div class="block mb-4">
							<div class="block-heading">
								<h5>Regular Modals</h5>
								<p class="mt-2">Modals are streamlined, but flexible dialog prompts powered by JavaScript. They support a number of use cases from user notification to completely custom content and feature a handful of helpful subcomponents, sizes, and more. You can read full bootstrap documentation about Modals by
									<a href="http://getbootstrap.com/docs/4.0/components/modal/" target="_blank" class="btn-link">clicking here</a>
								</p>
							</div>

							<h6 class="mb-3">Regular Modal</h6>

							<button class="btn btn-primary" data-target="#exampleModal1" data-toggle="modal">Launch demo modal</button>
						...
						<div class="block">
							<div class="block-heading">
								...
								<p class="mt-2">Modals have two optional sizes, available via modifier classes to be placed on a <span class="badge badge-outline-primary">.modal-dialog</span>. These sizes kick in at certain breakpoints to avoid horizontal scrollbars on narrower viewports.</p>
							</div>

							<button class="mr-2 btn btn-primary" data-target=".bd-example-modal-lg" data-toggle="modal"> Large modal</button>
							<!-----Modal Example----->
							...
							<button class="btn btn-primary" data-target=".bd-example-modal-sm" data-toggle="modal" type="button"> Small modal</button>
							<!-----Modal Example----->
