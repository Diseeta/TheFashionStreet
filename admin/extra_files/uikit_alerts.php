...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/uikit_alerts.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="navigation-menu">
        ...
        <ul class="menu-items custom-scroll">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="uikit_alerts.html" class="active">
                            <span class="icon-thumbnail"><i class="dripicons-warning"></i></span>
                    ...
                    <div class="col-12">
                        <div class="block mb-4">
                            <div class="block-heading">
                                ...
                                <p class="mt-2">Provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages. Alerts are available for any length of text, as well as an optional dismiss button. For proper styling, use one of the four required contextual classes (e.g. <span class="badge  badge-outline-primary">.alert-success</span>). For inline dismissal, use the alerts jQuery plugin. To learn more about bootstrap alerts <a href="http://getbootstrap.com/docs/4.0/components/alerts/" target="_blank" class="btn-link"> click here.</a></p>
                            </div>
                        ...
                        <div class="block mb-4">
                            <div class="block-heading">
                                ...
                                <p class="mt-2">Alerts can also contain additional HTML elements like headings and paragraphs.</p>
                            </div>

                            <div class="alert alert-success" role="alert">
                                <h4 class="alert-heading">Well done!</h4>
                                Aww yeah, you successfully read this important alert message. This example text is going to run a bit longer so that you can see how spacing within an alert works with this kind of content.<br><br>Whenever you need to, be sure to use margin utilities to keep things nice and tidy.
                            </div>
                        ...
                        <div class="block mb-4">
                            <div class="block-heading">
                                <h5>Dismissing</h5>
                                <p class="mt-2">Using the alert JavaScript plugin, it’s possible to dismiss any alert inline. Here’s how:</p>

                                <ul>
                                    <li>Be sure you’ve loaded the alert plugin, or the compiled Bootstrap JavaScript.</li>
                                    <li>Add a dismiss button and the <span class="badge  badge-outline-primary">.alert-dismissible</span> class, which adds extra padding to the right of the alert and positions the <span class="badge  badge-outline-primary">.close</span> button.</li>
                                    <li>On the dismiss button, add the <span class="badge  badge-outline-primary">data-dismiss="alert"</span> attribute, which triggers the JavaScript functionality. Be sure to use the <span class="badge  badge-outline-primary">&lt;button&gt;</span> element with it for proper behavior across all devices.</li>
                                    <li>To animate alerts when dismissing them, be sure to add the <span class="badge  badge-outline-primary">.fade</span> and <span class="badge  badge-outline-primary">.show</span> classes.</li>
                                </ul>
                            </div>
