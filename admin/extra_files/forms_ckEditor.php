...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/forms_ckEditor.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <ul class="menu-items custom-scroll">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="forms_ckEditor.html" class="active">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            <h4>Simple Wisiwig Editor</h4>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="block form-block mb-4">
                            <div class="block-heading">
                                <h5>Powered by CKEditor</h5>
                                <p class="mt-2">Create captivating content with multiple features available in CKEditor thanks to its plugin-based architecture. <a href="https://ckeditor.com/" target="_blank" class="btn-link">Learn More About CKEditor.</a></p>
                            </div>

                            <div>
                                <div class="form-group">
                                    <textarea id="textEditor" class="form-control" name="textEditor" row="4"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
