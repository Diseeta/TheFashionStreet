...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/charts_pie-doughnut.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <ul class="menu-items custom-scroll">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="charts_pie-doughnut.html" class="active">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 d-none d-lg-block">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Pie & Doughnut</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="block chart-block mb-4">
                            ...
                            <div class="chart-legends d-block d-md-flex justify-content-center">
                                <div class="legend-value-w ml-0 ml-md-2 mr-0 mr-md-2">
                                    <div class="legend-pin" style="background-color: #FF782E;"></div>
                                    <div class="legend-value">Processed</div>
                                </div>
                                <div class="legend-value-w ml-0 ml-md-2 mr-0 mr-md-2">
                                    <div class="legend-pin" style="background-color: #A5B5C5;"></div>
                                    <div class="legend-value">Pending</div>
                                </div>
                                <div class="legend-value-w ml-0 ml-md-2 mr-0 mr-md-2">
                                    <div class="legend-pin" style="background-color: rgb(102,187,106);"></div>
                                    <div class="legend-value">Completed</div>
                                </div>
                                <div class="legend-value-w ml-0 ml-md-2 mr-0 mr-md-2">
                                    <div class="legend-pin" style="background-color: #F65F6E;"></div>
