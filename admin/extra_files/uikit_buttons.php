...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/uikit_buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <ul class="menu-items custom-scroll">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="uikit_buttons.html" class="active">
            ...
            <div class="container-fluid" style="padding: 10px 25px">
                <div class="row">
                    ...
                    <div class="col-lg-8 d-none d-lg-block">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Dashbaord</a></li>
                    ...
                    <div class="col-12">
                        <div class="block mb-4">
                            <div class="block-heading">
                                ...
                                <p class="mt-3">Use Bootstrap’s custom button styles for actions in forms, dialogs, and more. Includes support for a handful of contextual variations, sizes, states, and more. Bootstrap includes six predefined button styles, each serving its own semantic purpose. To learn more about buttons in Bootstrap 4 <a href="http://getbootstrap.com/docs/4.0/components/buttons/" target="_blank" class="btn-link">Click here to know more.</a></p>
                            </div>
                        ...
                        <div class="block mb-4">
                            <div class="block-heading">
                                ...
                                <p class="mt-3">In need of a button, but not the hefty background colors they bring? Replace the default modifier classes with the <span class="badge  badge-outline-primary">.btn-outline-*</span> ones to remove all background images and colors on any button.</p>
                            </div>
                        ...
                        <div class="block mb-4">
                            <div class="block-heading">
                                ...
                                <p class="mt-3">To make button rounded add .btn-rounded class.<span class="badge  badge-outline-primary">.btn-rounded*</span></p>
                            </div>

                            <div class="buttons">
                                <button class="btn btn-outline-primary btn-rounded">Primary</button>
                                <button class="btn btn-primary btn-rounded">Primary</button>
                                <button class="btn btn-outline-dark btn-rounded">Secondary</button>
                                <button class="btn btn-dark btn-rounded">Secondary</button>
                            </div>
