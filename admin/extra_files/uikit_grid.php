...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/uikit_grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
	<meta charset="UTF-8">
		...
		<ul class="menu-items custom-scroll">
			...
			<li>
				...
				<ul class="sub-menu">
					...
					<li>
						<a href="uikit_grid.html" class="active">
					...
					<div class="col-12">
						<div class="block mb-4">
							<div class="block-heading">
								<h5>Grid Example</h5>
								<p class="mt-3">Bootstrap’s grid system uses a series of containers, rows, and columns to layout and align content. It’s built with flexbox and is fully responsive. Below is an example and an in-depth look at how the grid comes together.</p>
							</div>

							<div class="">
								<div class="container-fluid">
									<div class="row">
										<div class="example-column col-1 black-text">.col-1</div>
										<div class="example-column col-1">.col-1</div>
										<div class="example-column col-1">.col-1</div>
										<div class="example-column col-1">.col-1</div>
										<div class="example-column col-1">.col-1</div>
										<div class="example-column col-1">.col-1</div>
										...
										<div class="example-column col-1">.col-1</div>
										<div class="example-column col-1 black-text">.col-1</div>
										<div class="example-column col-1 black">.col-1</div>
									</div>
									<div class="row">
										<div class="example-column col-2">.col-2</div>
										<div class="example-column col-2">.col-2</div>
										<div class="example-column col-2">.col-2</div>
										<div class="example-column col-2">.col-2</div>
										<div class="example-column col-2">.col-2</div>
									...
									<div class="row">
										<div class="example-column col-3">.col-3</div>
										<div class="example-column col-3">.col-3</div>
										<div class="example-column col-3">.col-3</div>
										<div class="example-column col-3">.col-3</div>
									</div>
									<div class="row">
										<div class="example-column col-4">.col-4</div>
										<div class="example-column col-4">.col-4</div>
										<div class="example-column col-4">.col-4</div>
									</div>
									<div class="row">
										<div class="example-column col-5">.col-5</div>
										<div class="example-column col-7">.col-7</div>
									</div>
									<div class="row">
										<div class="example-column col-6">.col-6</div>
										<div class="example-column col-6">.col-6</div>
									</div>
									<div class="row">
										<div class="example-column col-12">.col-12</div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="block">
							<div class="block-heading">
								<h5>Grid System</h5>
								<p class="mt-3">Bootstrap includes a powerful mobile-first flexbox grid system for building layouts of all shapes and sizes. It’s based on a 12 column layout and has multiple tiers, one for each
									<a href="#" class="btn-link">media query range.</a> You can use it with Sass mixins or our predefined classes. You can read more about bootstrap grid by <a href="#" class="btn-link">clicking here.</a></p>
							</div>
							...
							<div class="table-responsive">
								<table class="table-v2 table table-bordered table-striped table-responsive">
									...
									<tr>
										...
										<th class="text-center">Double Extra large
											<br><small>≥1450px</small></th>
									</tr>
									</thead>
									<tbody>
									<tr>
