...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/tables_editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:53 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <ul class="menu-items custom-scroll">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="tables_editable.html" class="active">
                    ...
                    <div class="col-12">
                        <div class="block table-block mb-4">
                            <div class="block-heading">
                                <h5>Powered by Editable-Table</h5>
                                <p class="mt-2">This tiny (3KB, < 120 lines) jQuery plugin turns any table into an editable spreadsheet. Here are the key features: No magic - works on a normal HTML table (so you can plug it in into any web table, and apply any JS function to calculate values) and many more. <a href="https://mindmup.github.io/editable-table/" target="_blank" class="btn-link">Learn More about it</a></p>
                            </div>

                            <div class="table-responsive">
                                <table class="display table table-striped table-editable">
                                    <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Position</th>
