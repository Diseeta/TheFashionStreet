...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/charts_line.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="navigation-menu">
        ...
        <ul class="menu-items custom-scroll">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="charts_line.html" class="active">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="block graph-block mb-4">
                            ...
                            <div class="chart">
                                <canvas id="singleLineChart" class="chart"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="block graph-block bg-primary mb-4">
                            ...
                            <div class="chart">
                                <canvas id="filledWhiteLineChart" class="chart"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="block graph-block mb-4">
                            <div class="block-heading">
                                <h5>Double Line Chart</h5>
                            </div>
                            <div class="chart">
                                <canvas id="doubleLineChart" class="chart"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
