...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/charts_sparkline.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <ul class="menu-items custom-scroll">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="charts_sparkline.html" class="active">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="content sm-gutter">
            <div class="container-fluid padding-25 sm-padding-10">
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="block chart-block mb-4">
                            <div class="block-heading d-flex align-items-center">
                                <h4>Total Visit</h4>
                                <span class="pull-right badge badge-success badge-pill ml-auto"><i class="fa fa-caret-up mr-1"></i>18%</span>
                            </div>
                            <div class="stats-row mb-2">
                                <div class="stat-item">
                                    <h6 class="stat-title">Overall Growth</h6>
                                    <b>80.40%</b>
                                </div>
                                <div class="stat-item">
                                    <h6 class="stat-title">Montly</h6>
                                    <b>15.40%</b>
                                </div>
                                <div class="stat-item">
                                    <h6 class="stat-title">Day</h6>
                                    <b>5.50%</b>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="block chart-block bg-primary mb-4">
                            <div class="block-heading">
                                <h4>Line Chart</h4>
                            </div>
