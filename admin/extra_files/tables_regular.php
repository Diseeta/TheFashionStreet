    ...
    <div class="navigation-menu">
        ...
        <ul class="menu-items custom-scroll">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="tables_regular.html" class="active">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="block table-block mb-4">
                            <div class="block-heading">
                                <h5>Table in white block</h5>
                                <p class="mt-2">You can put a table tag inside an <span class="badge badge-outline-primary">.block</span> class div and add <span class="badge badge-outline-primary">.table</span> class to it to get something like this:</p>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><img alt="" src="img/flags-icons/ca.html" width="25px"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img alt="" src="img/flags-icons/uk.html" width="25px"></td>
                                        <td class="status success">Success</td>
                                        <td class="price text-right">$156</td>
                                    </tr>
                                    <tr>
                                        <td>Joe Trulli</td>
                                        <td class="text-center">1,256</td>
                                        <td><img alt="" src="img/flags-icons/es.html" width="25px"></td>
                                        <td class="status pending">Pending</td>
                                        <td class="price text-right">$1,120</td>
                                    </tr>
                                    <tr>
                                        <td>Fred Kolton</td>
                                        <td class="text-center">74</td>
                                        <td><img alt="" src="img/flags-icons/fr.html" width="25px"></td>
                                        <td class="status danger">Over Due</td>
                                        <td class="price text-right">$74</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="col-6">
                        <div class="block bg-trans table-block mb-4">
                            <div class="block-heading">
                                <h5>Table in transparent block</h5>
                                <p class="mt-2">You can add <span class="badge badge-outline-primary">.bg-trans</span> and <span class="badge badge-outline-primary">.block</span> class to main div to get something like this:</p>
                            </div>
                    ...
                    <div class="col-6">
                        <div class="block table-block mb-4">
                            <div class="block-heading">
                                <h5>Table Striped</h5>
                                <p class="mt-2">You can add class <span class="badge badge-outline-primary">.table-striped</span>  and <span class="badge badge-outline-primary">.table</span> to a table element to get striped table:</p>
                            </div>
                    ...
                    <div class="col-6">
                        <div class="block table-block mb-4">
                            <div class="block-heading">
                                ...
                                <p class="mt-2">You can add class <span class="badge badge-outline-primary">.table-bordered</span>  and <span class="badge badge-outline-primary">.table</span> to a table element to get bordered table:</p>
                            </div>
