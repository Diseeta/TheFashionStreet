...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/uikit_progress.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
	<meta charset="UTF-8">
		...
		<ul class="menu-items custom-scroll">
			...
			<li>
				...
				<ul class="sub-menu">
					...
					<li>
						<a href="uikit_progress.html" class="active">
				...
				<div class="row">
					...
					<div class="col-lg-8 d-none d-lg-block">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Uikit</li>
				...
				<div class="row">
					<div class="col-12">
						<div class="section-title">
							<h4>Examples of Progress Bars</h4>
						</div>
					</div>
					...
					<div class="col-12">
						<div class="block mb-4">
							<div class="block-heading">
								<h5>Progress</h5>
								<p class="mt-2">Use our custom progress component for displaying simple or complex progress bars. Progress components are built with two HTML elements, some CSS to set the width, and a few attributes. </p>
							</div>

							<ul>
								<li>We use the <span class="text-primary">.progress</span> as a wrapper to indicate the max value of the progress bar.</li>
								<li>We use the inner <span class="text-primary">.progress-bar</span> to indicate the progress so far.</li>
								<li>The <span class="text-primary">.progress-bar</span> requires an inline style, utility class, or custom CSS to set their width</li>
								<li>The <span class="text-primary">.progress-bar</span> also requires some <span class="text-primary">role</span> and <span class="text-primary">aria</span> attributes to make it accessible.</li>
							</ul>

							<p>Learn more about Bootstrap progress bars by <a href="http://getbootstrap.com/docs/4.0/components/progress/" target="_blank" class="btn-link">Clicking here.</a> Put that all together, and you have the following examples.</p>

							<div class="mt-4">
								<div class="progress mb-3"><div aria-valuemax="100" aria-valuemin="0" aria-valuenow="0" class="progress-bar" role="progressbar"></div></div>
								<div class="progress mb-3"><div aria-valuemax="100" aria-valuemin="0" aria-valuenow="25" class="progress-bar" role="progressbar" style="width: 25%"></div></div>
								<div class="progress mb-3"><div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="progress-bar" role="progressbar" style="width: 50%"></div></div>
								<div class="progress mb-3"><div aria-valuemax="100" aria-valuemin="0" aria-valuenow="75" class="progress-bar" role="progressbar" style="width: 75%"></div></div>
								<div class="progress mb-3"><div aria-valuemax="100" aria-valuemin="0" aria-valuenow="100" class="progress-bar" role="progressbar" style="width: 100%"></div></div>
							</div>
						...
						<div class="row">
							<div class="col-6">
								<div class="block mb-4">
									<div class="block-heading">
										<h5>Labels</h5>
										<p class="mt-2">Add labels to your progress bars by placing text within the <span class="text-primary">.progress-bar</span></p>
									</div>

									<div>
										<div class="progress"><div aria-valuemax="100" aria-valuemin="0" aria-valuenow="25" class="progress-bar" role="progressbar" style="width: 25%;"> 25%</div></div>
									</div>
							...
							<div class="col-6">
								<div class="block mb-4">
									<div class="block-heading">
										<h5>Backgrounds</h5>
										<p class="mt-2">Use background utility classes to change the appearance of individual progress bars.</p>
									</div>

									<div>
										<div class="progress mb-3"><div aria-valuemax="100" aria-valuemin="0" aria-valuenow="25" class="progress-bar bg-success" role="progressbar" style="width: 25%"></div></div>
										<div class="progress mb-3"><div aria-valuemax="100" aria-valuemin="0" aria-valuenow="75" class="progress-bar bg-warning" role="progressbar" style="width: 75%"></div></div>
										<div class="progress mb-3"><div aria-valuemax="100" aria-valuemin="0" aria-valuenow="100" class="progress-bar bg-danger" role="progressbar" style="width: 100%"></div></div>
									</div>
