...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/pages_register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="register-div">
                        ...
                        <form id="needs-validation" action="#" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-lg" placeholder="Enter first name" type="text" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>

                            <div class="form-group">
                                <label>Email</label>
                                <input class="form-control input-lg" placeholder="Enter email address" type="email" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>

                            <div class="form-group">
                                <label>Create Password</label>
                                <input class="form-control input-lg" placeholder="Create strong password" type="password" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>

                            <div class="form-group">
                                <label>Confirm Password</label>
                                <input class="form-control input-lg" placeholder="Confirm password" type="password" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>
