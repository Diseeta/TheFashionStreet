...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/uikit_tooltips.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
	<meta charset="UTF-8">
		...
		<ul class="menu-items custom-scroll">
			...
			<li>
				...
				<ul class="sub-menu">
					...
					<li>
						<a href="uikit_tooltips.html" class="active">
				...
				<div class="row">
					...
					<div class="col-12">
						<div class="block mb-4">
							<h5>Learn About Tooltips</h5>
							<p class="mt-2">Inspired by the excellent Tipsy jQuery plugin written by Jason Frame. Tooltips are an updated version, which don’t rely on images, use CSS3 for animations, and data-attributes for local title storage. Learn more about tooltips in Bootstrap 4 by <a tabindex="0" href="https://getbootstrap.com/docs/4.0/components/tooltips/" target="_blank" class="btn-link">clicking here</a></p>
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="block mb-4">
							<div class="block-heading">
								<h5>Example in content</h5>
								<p class="mt-2">Hover over the links below to see tooltips:</p>
							</div>

							<p>
								Tight pants next level keffiyeh <a href="#" class="btn-link" data-toggle="tooltip" title="" data-original-title="Default tooltip"><strong>you probably</strong></a> haven't heard of them. Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeney's fixie sustainable quinoa 8-bit american apparel <a href="#" class="btn-link" data-toggle="tooltip" title="" data-original-title="Another tooltip"><strong>have a</strong></a> terry richardson vinyl chambray. Beard stumptown, cardigans banh mi lomo thundercats. Tofu biodiesel williamsburg marfa, four loko mcsweeney's cleanse vegan chambray. A really ironic artisan <a href="#" class="btn-link" data-toggle="tooltip" title="" data-original-title="Another one here too"><strong>whatever keytar</strong></a>, scenester farm-to-table banksy Austin <a href="#" class="btn-link" data-toggle="tooltip" title="" data-original-title="The last tip!"><strong>twitter handle</strong></a> freegan cred raw denim single-origin coffee viral.
							</p>
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="block mb-4">
							<div class="block-heading">
								<h5>Hover Example on buttons</h5>
								<p class="mt-2">Hover over the buttons below to see tooltips:</p>
							</div>

							<div class="">
								<button class="btn btn-success m-2" data-placement="top" data-toggle="tooltip" title="" type="button" data-original-title="Tooltip on top">Tooltip on top</button>
								<button class="btn btn-success m-2" data-placement="right" data-toggle="tooltip" title="" type="button" data-original-title="Tooltip on right">Tooltip on right</button>
								<button class="btn btn-success m-2" data-placement="bottom" data-toggle="tooltip" title="" type="button" data-original-title="Tooltip on bottom">Tooltip on bottom</button>
								<button class="btn btn-success m-2" data-placement="left" data-toggle="tooltip" title="" type="button" data-original-title="Tooltip on left">Tooltip on left</button>
							</div>
						</div>
					</div>
