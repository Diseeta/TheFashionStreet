...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/dashboard_tasks-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:39 GMT -->
<head>
	<meta charset="UTF-8">
		...
		<ul class="menu-items custom-scroll">
			<li>
				...
				<ul class="sub-menu">
					...
					<li>
						<a href="dashboard_tasks-list.html" class="active">
	...
	<div class="page-content-wrapper">
		...
		<div class="content sm-gutter">
			<div class="container-fluid padding-25 sm-padding-10">
				<div id="sortable1" class="row">
					<div class="col-12 col-sm-6 col-md-4 col-lg-4 mb-3 mb-lg-0">
						<div class="block task-block">
							<div class="section-title">
								<h5>To Do</h5>
								<a href="javascript:;" class="circle-info-btn" data-toggle="tooltip" data-title="Add Task"><i class="fa fa-plus"></i></a>
							</div>
							...
							<ul id="todo">
								...
								<li>
									<div class="task align-items-center">
										<div class="task-desc">
											<p class="task-title text-truncate">Product page Re-Design</p>
											<span class="end-time text-truncate">Today</span>
										</div>
										<div class="members single">
											<div class="member rounded-circle float-right" data-toggle="tooltip" data-title="Meera Singh">
												<img class="img-fluid" src="assets/images/1.jpg">
												<span class="badge badge-secondary badge-circle"><i class="fa fa-users"></i></span>
											</div>
										</div>
									</div>
								</li>
								...
								<li>
									<div class="task urgent align-items-center">
										<div class="task-desc">
											<p class="task-title text-truncate">Product page Re-Design</p>
											<span class="end-time text-truncate">ASAP!</span>
										</div>
										<div class="members">
											<div class="member rounded-circle float-right" data-toggle="tooltip" data-title="John Doe<br>Meera Singh">
								...
								<li>
									<div class="task over-due align-items-center">
										<div class="task-desc">
											<p class="task-title text-truncate">Gallery website change Theme</p>
											<span class="end-time text-truncate">Aug 25, 2017</span>
										</div>
										<div class="members">
											<div class="member rounded-circle float-right" data-toggle="tooltip" data-title="Stacy, John, Meera">
								...
								<li>
									<div class="task align-items-center">
										...
										<div class="members single">
											<div class="member rounded-circle float-right" data-toggle="tooltip" data-title="Meera, John, Stacy">
								...
								<li>
									<div class="task align-items-center">
										<div class="task-desc">
											<p class="task-title text-truncate">Product page Re-Design</p>
											<span class="end-time text-truncate">Today - Tomorrow</span>
										</div>
										<div class="members single">
											<div class="member rounded-circle float-right" data-toggle="tooltip" data-title="Meera, John, Stacy">
							...
							<ul id="inprogress">
								...
								<li>
									<div class="task over-due align-items-center">
										<div class="task-desc">
											<p class="task-title text-truncate">Gallery website change Theme</p>
											<span class="end-time text-truncate">Aug 23, 2017</span>
										</div>
										<div class="members">
											<div class="member rounded-circle float-right" data-toggle="tooltip" data-title="Meera, John, Stacy">
							...
							<ul id="taskdone">
								...
								<li>
									<div class="task over-due align-items-center">
										...
										<div class="members">
											<div class="member rounded-circle float-right" data-toggle="tooltip" data-title="Meera, John, Meera">
												<img class="img-fluid" src="assets/images/5.jpg">
												<span class="badge badge-secondary badge-circle"><i class="fa fa-users"></i></span>
											</div>
										</div>
								...
								<li>
									<div class="task align-items-center">
										...
										<div class="members">
											<div class="member rounded-circle float-right" data-toggle="tooltip" data-title="Meera, John, Meera">
												<img class="img-fluid" src="assets/images/9.jpg">
												<span class="badge badge-secondary badge-pill">+2 more</span>
											</div>
										</div>
									</div>
								</li>
...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/dashboard_tasks-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
</html>