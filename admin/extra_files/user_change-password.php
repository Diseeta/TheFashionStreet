...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/user_change-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:36 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="login-div">
                        ...
                        <p class="mb-4" style="color: #a5b5c5">Change password of your account</p>
                        <form id="needs-validation" action="#" novalidate>
                            <div class="form-group">
                                <label>Old Password</label>
                                <input class="form-control input-lg" placeholder="Enter old password" type="password" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>
                            <div class="form-group">
                                <label>New Password</label>
                                <input class="form-control input-lg" placeholder="Create new password" type="password" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>

                            <div class="form-group">
                                <label>Confirm New Password</label>
                                <input class="form-control input-lg" placeholder="Confirm new password" type="password" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>

                            <button class="btn btn-primary mt-2">Change Password</button>

                            <small class="text-muted mt-5 mb-1 d-block">Get me back to <a href="index.html">Dashboard</a></small>
                        </form>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/user_change-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:39 GMT -->
</html>