...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/forms_uploads.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <ul class="menu-items custom-scroll">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="forms_uploads.html" class="active">
                    ...
                    <div class="col-md-12">
                        <div class="block form-block mb-4">
                            <div class="block-heading">
                                <h5>Dropzone File Upload</h5>
                                <p class="mt-2">DropzoneJS is an open source library that provides drag’n’drop file uploads with image previews. <a href="http://www.dropzonejs.com/http://www.dropzonejs.com/" target="_blank" class="btn-link">Learn More here</a></p>
                            </div>
