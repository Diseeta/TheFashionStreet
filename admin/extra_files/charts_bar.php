...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/charts_bar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <ul class="menu-items custom-scroll">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="charts_bar.html" class="active">
                            <span class="icon-thumbnail"><i class="dripicons-graph-bar"></i></span>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="block graph-block mb-4">
                            ...
                            <div class="chart">
                                <canvas id="barGraphPrimary" class="chart"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="block graph-block mb-4">
                            <div class="block-heading">
                                <h5>Gradient Color</h5>
                            </div>
                            <div class="chart">
                                <canvas id="barGraphGradient" class="chart"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="block graph-block bg-primary mb-4">
                            <div class="block-heading" style="border-color: rgba(255,255,255,0.05)">
                                <h5 class="text-white">White Outline Chart</h5>
                            </div>
                            <div class="chart">
                                <canvas id="barGraphWhite" class="chart"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="block graph-block mb-4">
                            ...
                            <div class="chart">
                                <canvas id="barGraphDark" class="chart"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="block graph-block mb-4">
                            ...
                            <div class="chart">
                                <canvas id="barGraphLight" class="chart"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
