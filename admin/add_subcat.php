                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="block form-block mb-4">
                            ...
                            <form action="add_subcat_proc.php" class="horizontal-form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Sub Category" type="text" name="name">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
