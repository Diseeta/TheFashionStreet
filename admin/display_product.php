                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><img alt="" src="../images/<?php echo $row[6]; ?>" width="100px"></td>
										<td><img alt="" src="../images/<?php echo $row[7]; ?>" width="100px"></td>
										<td><img alt="" src="../images/<?php echo $row[8]; ?>" width="100px"></td>
