                    ...
                    <div class="col-12 col-lg-8">
                        <div class="block form-block mb-4">
							...
							<?php
								...
								$id=$_GET["id"];
								$result = mysql_query("select * from sub_category where id=$id");
								$row = mysql_fetch_row($result);
							?>

                            <form action="edit_subcat_proc.php" class="horizontal-form" method="post" enctype="multipart/form-data">
							<input type="hidden" value="<?php echo $id; ?>" name="id" />
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Sub Category</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Sub Category" type="text" name="sub_name" value="<?php echo $row[2]; ?>">
                                        </div>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <img alt="" src="../images/<?php echo $row[3]; ?>" width="100px">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
								...
								<div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <img alt="" src="../images/<?php echo $row[4]; ?>" width="100px">
                                        </div>
                                    </div>
                                </div>
								 ...
								 <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">image1</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="image" type="file" name="image1">
                                        </div>
                                    </div>
                                </div>
