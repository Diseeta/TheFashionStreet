...
<head>
    ...
    <title>FASHION STREET | ADMIN</title>
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="block form-block mb-4">
                            ...
                            <form action="add_product_proc.php" class="horizontal-form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-9">
                                           <select name="sub_id"  class="form-control">
												...
												<?php 
													...
													$result = mysql_query("select * from sub_category");
													$row = mysql_fetch_row($result);
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Product Size</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter product Size" type="text" name="psize">
                                        </div>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter price" type="file" name="img2"> 
                                        </div>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter price" type="file" name="img3"> 
                                        </div>
                                    </div>
                                </div>
