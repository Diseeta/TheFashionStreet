			...
			<div class="login">
				<div class="main-agileits">
					<div class="form-w3agile">
						...
						<form action="forgot_pwd_proc.php" method="post">
							<div class="key">
							...
							<div class="key">
								<i  aria-hidden="true"></i>
								<input  type="text" value="Enter your answer" name="answer" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'answer';}" required="">
								<div class="clearfix"></div>
							</div>
