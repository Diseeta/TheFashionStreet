...
<body>
	<!--header-->
		...
		<div class="content">
			...
			<div class="latest-w3">
				<div class="container">
					<h3 class="tittle1">Our Categories</h3>
					...
					?>
						<div class="col-md-3 latest-grid">
							<a href="products.php?id=<?php echo $row[0]; ?>" >
							<div class="latest-top">
								<img  src="images/<?php echo $row[2]; ?>" class="img-responsive"  alt=""> 
								...
								<ul class="rslides" id="slider">
									<li>	 
										...
										<?php 
												...
												$result = mysql_query("select * from product order by pid DESC limit 4");
												$row = mysql_fetch_row($result);
